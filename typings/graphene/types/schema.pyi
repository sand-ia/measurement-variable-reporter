...
def assert_valid_root_type(_type): # -> None:
    ...
...
class Schema(GraphQLSchema):
    ...
    """
    def __init__(self, query=..., mutation=..., subscription=..., directives=..., types=..., auto_camelcase=...) -> None:
        ...
    
    def get_query_type(self): # -> GraphQLNamedType | None:
        ...
    
    def get_mutation_type(self): # -> GraphQLNamedType | None:
        ...
    
    def get_subscription_type(self): # -> GraphQLNamedType | None:
        ...
    ...
    def get_graphql_type(self, _type): # -> GraphQLNamedType:
        ...
    ...
    def lazy(self, _type): # -> () -> (GraphQLNamedType | None):
        ...
