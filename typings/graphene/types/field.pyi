...
base_type = type
def source_resolver(source, root, info, **args): # -> Any | None:
    ...
...
class Field(MountedType):
    ...
    """
    def __init__(self, type, args=..., resolver=..., source=..., deprecation_reason=..., name=..., description=..., required=..., _creation_counter=..., default_value=..., **extra_args) -> None:
        ...
    
    @property
    def type(self): # -> Any | NonNull | Unknown:
        ...
