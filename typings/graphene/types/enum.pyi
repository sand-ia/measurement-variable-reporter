...
class EnumMeta(SubclassWithMeta_Meta):
    def __new__(cls, name, bases, classdict, **options): # -> Self@EnumMeta:
        ...
    ...
    def __prepare__(name, bases, **kwargs): # -> OrderedDict[Unknown, Unknown]:
        ...
    
    def __call__(cls, *args, **kwargs): # -> Any:
        ...
    
    def from_enum(cls, enum, description=..., deprecation_reason=...): # -> Any:
        ...
...
class Enum(six.with_metaclass(EnumMeta, UnmountedType, BaseType)):
    ...
    """
    @classmethod
    def __init_subclass_with_meta__(cls, enum=..., _meta=..., **options): # -> None:
        ...
